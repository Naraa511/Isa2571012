...
const foodGroupMnMap = {
  ...
  "Starchy Roots and Starch products":
    "Цардуулт үндэс ба цардуулан бүтээгдэхүүн",
...
const collectionAreaMnMap = {
  ...
  "Darkhan-Uul province, Plant Protection and Research Institute":
    "Дархан-Уул аймаг, Ургамал хамгаалал эрдэм шинжилгээний хүрээлэн",
  "Darkhan-Uul province, Ulaanbaatar flour mill JSC":
    "Дархан-Уул аймаг, Улаанбаатар гурил ХК",
  ...
  "Darkhan-Uul province, Arshaantiin 18 LLC":
    "Дархан-Уул аймаг, Аршаантын 18 ХХК",
  ...
  "Tuv province, Batsumber village, Rashaant 61":
    "Төв аймаг, Батсүмбэр сум, Рашаант 61",
...
const additionalInfoMnMap = {
  "Product name: Fiber barley  flour":
    "Бүтээгдэхүүний нэр: Эслэгтэй арвайн гурил",
  "Product name: Pearled barley flour,  Rousted barley flour":
    "Бүтээгдэхүүний нэр: Хальсалсан арвайн гурил, Шарсан арвайн гурил",
  "Product name: Talkh chikher, Misheel brand, Rye bread":
    "Бүтээгдэхүүний нэр: Талх чихэр, Мишээл брэнд, Хөх тарианы талх",
  "Product name: Talkh chikher, Atar brand, wheat bread":
    "Бүтээгдэхүүний нэр: Талх чихэр, Атар брэнд, Улаанбуудайн талх",
  ...
  "Product name: Lapsha, Ribbon noodle with multigrain flour":
    "Бүтээгдэхүүний нэр: Лапша, олон үрийн гурилтай хавтгай гоймон",
  "Product name: Oat flour": "Бүтээгдэхүүний нэр: Овьёосны гурил",
  "Product name: Ulaanbaatar flour,  First grade wheat flour":
    "Бүтээгдэхүүний нэр: Улаанбаатар гурил, Нэгдүгээр гурил",
  "Product name: Ulaanbaatar flour,  Premium grade wheat flour":
    "Бүтээгдэхүүний нэр: Улаанбаатар гурил, Дээд гурил",
  "Product name: Altan duulga flour,  whole wheat flour":
    "Бүтээгдэхүүний нэр: Алтан дуулга гурил, Бүхэл үрийн гурил",
  "Product name: Tungalag, vermicelli":
    "Бүтээгдэхүүний нэр: Тунгалаг, вермишель",
  "Product name: Flax flour": "Бүтээгдэхүүний нэр: Маалингын гурил",
  "Product name: Flax seeds": "Бүтээгдэхүүний нэр: Маалингын үр",
  "Product name: Hushkhan pine nut seeds":
    "Бүтээгдэхүүний нэр: Хушхан самрын үр",
  "Product name: Hushkhan pine nut": "Бүтээгдэхүүний нэр: Хушхан самар",
  "Product name: Seabuckthorn condenced jiuce":
    "Бүтээгдэхүүний нэр: Чацарганы өтгөрүүлсэн шүүс",
  "Product name: Tumen shuvuut,  Egg":
    "Бүтээгдэхүүний нэр: Түмэн шувуут, Өндөг",
  "Product name: Duuren, canned fish":
    "Бүтээгдэхүүний нэр: Дүүрэн, лаазалсан загас",
  "Product name: Seabuckthorn pulp oil":
    "Бүтээгдэхүүний нэр: Чацарганы зөөлөн эдийн тос",
  "Product name: Seabuckthorn seed oil":
    "Бүтээгдэхүүний нэр: Чацарганы үрийн тос",
};
...
const discardedPartMnMap = {
  ...
  "stem, seed": "Иш, үр",
  leaves: "Навч",
  "bones, visible firm and some soft connective tissues":
    "Яс, харагдах хатуу болон зөөлөн холбогч эд",
...
const cookingMethodMnMap = {
  ...
  "wash in water and use, drying powder":
    "Усаар угааж хэрэглэх, хатааж нунтаглах",
  ...
  "boiling, bake, fry in oil, pickling, direct use":
    "Чанах, жигнэх, тосонд шарах, даршлах, шууд хэрэглэнэ.",
...
const ReferenceForConditionSettingMnMap = {
  ...
  "Store for 1 year at with in a cool dry place away from sunlig.":
    "Нарны шууд тусгалаас хол, сэрүүн хуурай газар 1 жил хадгална.",
...
const output = data.map((item) => {
  ...
  return {
    ...
    collection_information: {
      "Collection area": toLangObject(
        collectionArea,
        collectionAreaMnMap[collectionArea],
      ),
      "Collection date": collectionInfo["Collection date"],
      "Basis of sample selection": toLangObject(basis, basisMnMap[basis]),
      "Additional collection information": toLangObject(
        additionalInfo,
        additionalInfoMnMap[additionalInfo],
      ),
    },
    edible_inedible_part: {
      "Weight of whole part (g/1 piece)":
        ediblePart["Weight of whole part (g/1 piece)"],
      "Weight of edible part (g/1 piece)":
        ediblePart["Weight of edible part (g/1 piece)"],
      ...
      "Weight of inedible part (g/1 piece)":
        ediblePart["Weight of inedible part (g/1 piece)"],
    },
    pretreatment_conditions: {
      ...
      "Reference for condition setting": toLangObject(
        ...
        ReferenceForConditionSettingMnMap[
          pretreatment["Reference for condition setting"]
        ],
      ),
    },
